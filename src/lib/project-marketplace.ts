...
export const POPULAR_PROJECTS: PopularProject[] = [
  ...
  { key: "country-garden-danga-bay", slug: "country-garden-danga-bay", dbName: "Country Garden Danga Bay", rentalDemandScore: 4, tag: "family" },
...
export function getProjectDisplayName(key: ListingEnrichmentKey, locale: Locale): string {
  const names: Record<Locale, Record<ListingEnrichmentKey, string>> = {
    ...
    zh: {
      ...
      "danga-bay": "丹加湾",
      "country-garden-danga-bay": "碧桂园丹加湾",
      "bukit-indah": "武吉英达",
      "mount-austin": "奥斯汀山",
      "eco-botanic": "生态植物园",
      medini: "美迪尼",
